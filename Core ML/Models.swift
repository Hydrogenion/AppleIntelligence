...
extension Models {
  ...
  static var emptyNeuralNetworkURL: URL {
      urlForModelInDocumentsDirectory(.emptyNeuralNetwork)
  }
  ...
  private static func urlForModelInDocumentsDirectory(_ model: Models) -> URL {
    AppleTrainer.urlForModelInDocumentsDirectory(model.rawValue)
  }
  ...
  static func loadEmptyNeuralNetwork() -> MLModel? {
      loadModel(url: emptyNeuralNetworkURL)
  }
}
